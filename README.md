...
| --- | --- | --- |
| `ai-project-runner` | `skills/ai-project-runner/` | Prepares observable remote AI training workflows with SSH/tmux, auto-updating TensorBoard, logs, metrics, and checkpoints. |
